          ...
          <CardContent>
            <form action={joinGame} className="space-y-5">
              ...
              <Button
                type="submit"
                size="lg"
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-lg h-12 transition-all hover:scale-[1.02] active:scale-95"
              >
                Beitreten
              </Button>
            </form>
          ...
          <CardContent>
            <form action={createGame} className="space-y-5">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="w-full text-slate-300 border-slate-700 hover:bg-slate-800 h-12 transition-all hover:border-emerald-500 hover:text-emerald-400"
              >
                Lobby eröffnen
              </Button>
            </form>
