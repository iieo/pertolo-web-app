    ...
    return (
        <main className="max-w-2xl mx-auto p-8 font-sans">
            ...
            <section className="mb-6">
                ...
                <h4 className="font-semibold mb-1">Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieser Website?</h4>
                <p className="mb-2">
            ...
            <section className="mb-6">
                ...
                <address className="not-italic mb-2">
                    Leopold Bauer<br />
                    Potsdamerstra&szlig;e 13<br />
                    80802 M&uuml;nchen
                </address>
                <p className="mb-2">
                    Telefon: <a href="tel:+4917681701855" className="text-blue-600 hover:underline">+4917681701855</a><br />
                    E-Mail: <a href="mailto:leopoldbauer@duck.com" className="text-blue-600 hover:underline">leopoldbauer@duck.com</a>
                </p>
                <p className="mb-2">
                ...
                <h3 className="text-xl font-semibold mb-2">Hinweis zur Datenweitergabe in datenschutzrechtlich nicht sichere Drittstaaten sowie die Weitergabe an US-Unternehmen, die nicht DPF-zertifiziert sind</h3>
                <p className="mb-2">
                    Wir verwenden unter anderem Tools von Unternehmen mit Sitz in datenschutzrechtlich nicht sicheren Drittstaaten sowie US-Tools, deren Anbieter nicht nach dem EU-US-Data Privacy Framework (DPF) zertifiziert sind. Wenn diese Tools aktiv sind, k&ouml;nnen Ihre personenbezogene Daten in diese Staaten &uuml;bertragen und dort verarbeitet werden. Wir weisen darauf hin, dass in datenschutzrechtlich unsicheren Drittstaaten kein mit der EU vergleichbares Datenschutzniveau garantiert werden kann.
                </p>
                <p className="mb-2">
                    Wir weisen darauf hin, dass die USA als sicherer Drittstaat grunds&auml;tzlich ein mit der EU vergleichbares Datenschutzniveau aufweisen. Eine Daten&uuml;bertragung in die USA ist danach zul&auml;ssig, wenn der Empf&auml;nger eine Zertifizierung unter dem &bdquo;EU-US Data Privacy Framework&ldquo; (DPF) besitzt oder &uuml;ber geeignete zus&auml;tzliche Garantien verf&uuml;gt. Informationen zu &Uuml;bermittlungen an Drittstaaten einschlie&szlig;lich der Datenempf&auml;nger finden Sie in dieser Datenschutzerkl&auml;rung.
                </p>
                ...
                <h3 className="text-xl font-semibold mb-2">Widerspruchsrecht gegen die Datenerhebung in besonderen F&auml;llen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
                <p className="mb-2">
                ...
                <h3 className="text-xl font-semibold mb-2">Beschwerde&shy;recht bei der zust&auml;ndigen Aufsichts&shy;beh&ouml;rde</h3>
                <p className="mb-2">
                ...
                <h3 className="text-xl font-semibold mb-2">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
                <p className="mb-2">
                ...
                <h3 className="text-xl font-semibold mb-2">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
                <p className="mb-2">
            ...
            <section className="mb-6">
                ...
                <p className="mb-2">
                    Cookies k&ouml;nnen von uns (First-Party-Cookies) oder von Drittunternehmen stammen (sog. Third-Party-Cookies). Third-Party-Cookies erm&ouml;glichen die Einbindung bestimmter Dienstleistungen von Drittunternehmen innerhalb von Webseiten (z.&nbsp;B. Cookies zur Abwicklung von Zahlungsdienstleistungen).
                </p>
                <p className="mb-2">
            ...
            <section className="mb-6">
                ...
                <p className="mb-2">
                    ...
                    <a href="https://www.dataprivacyframework.gov/participant/5780" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                        https://www.dataprivacyframework.gov/participant/5780
                    </a>.
                </p>
                <h3 className="text-xl font-semibold mb-2">Google Fonts</h3>
                <p className="mb-2">
                    Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten so genannte Google Fonts, die von Google bereitgestellt werden. Beim Aufruf einer Seite l&auml;dt Ihr Browser die ben&ouml;tigten Fonts in ihren Browsercache, um Texte und Schriftarten korrekt anzuzeigen.
                </p>
                <p className="mb-2">
